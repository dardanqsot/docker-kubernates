package org.dardan.springcloud.msvc.cursos.controllers;
...
import org.dardan.springcloud.msvc.cursos.services.CursoService;
...
public class CursoController {
    ...
    public ResponseEntity<?> eliminarUsuario(@RequestBody Usuario usuario, @PathVariable Long cursoId) {
        ...
        try{
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).
                    body(Collections.singletonMap( "mensaje", "No se pudo eliminar usuario por" +
                            " el id o error en la comunicación: " + e.getMessage()));
        }
        if(o.isPresent()){
